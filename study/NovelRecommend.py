...
# def getSourceFileLists(source_dir):
#     fileLists = []
#     subDirList = os.listdir(source_dir)
#     for subDir in subDirList:
#         subList = os.listdir(source_dir + '/' + subDir)
#         fileList = [source_dir + '/' + subDir + '/' + x for x in subList if
#                     os.path.isfile(source_dir + '/' + subDir + '/' + x)]
#         fileLists += fileList
#
#     return fileLists
#
